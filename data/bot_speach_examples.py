...
def welcome_bot():
    ...
    word_list = [
        ...
        'Ку', 'Шотам','Агов', 'Ололо', 'Эй ты', 'Чо-чо'
    ]
...
def welcome_word_processor():
    ...
    word_list = [
        'жалкие людишки', 'унылые мотобратишки', 'несчастные кожанные мешочки',
        'мягкотелые созданья', 'человечьи шкурки', 'никчемные организмики',
        'органические биомаски', 'тупые хомосапиенсы', 'cмертное мяско',
        'земные животные', 'инкубаторы микробовиков', 'глупые приматики',
        'наборы хромосомок', 'подвижные углеводики', 'скучные костяные наборчики',
        'одноразовые людишки','приматики', 'угрюмые человечишки', 'мясные фаршики',
        'либители мото-некромантии','любители реальных дальняков на Мажорку'
    ]
...
def end_word_processor():
    ...
    end_word = [
        ...
        'Рулевая раскрутилась', 'Резина лысая', 'Цепь растянулась',
        ...
        'KLE500 устал', 'KLE уже всьо','Поклонитесь святому Bajaj',
        'Приборка не работает', 'Карбы забились', 'Некромопед подушатался', 'Бак течет',
        'Проводка погорела', 'Коробка сдохла', 'Вкладыши провернуло','Права отобрали','Страховка закончилась',
        'Мот продан, а на новый не хватает', 'Твой Мот уже давно закончил институт', 'Надену шлепки и майку и прокачусь на некробайке'
    ]
...
def weather_wind_speed_processor(wind_power):
    conditions = [
        ...
        'наваливает так что походу вам всем пиздец',
        'говорит что вам таки пиздец'
    ]
    # Convert M/S to KM/H 
...
def pep_talk():
    talk = ['но вы не унывайте', 'но вы не сдавайтесь', 'но вы терпите', 
            'но вы не горюйте','но вы держитесь','но вы не расслабляйтесь','но вы не вешайте нос']
